...
class fitFbkgflat : public RooAbsPdf {
public:
  fitFbkgflat(){}
  fitFbkgflat(const char *name, const char *title,
              RooAbsReal& _x,
              RooAbsCategory& _y,
              RooAbsReal& _bkg1,
              RooAbsReal& _bkg2);
  fitFbkgflat(const fitFbkgflat& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new fitFbkgflat(*this,newname); }
  inline virtual ~fitFbkgflat() { }
protected:
...
private:
  ...
  ClassDef(fitFbkgflat,1) // Your description goes here...
};
