...
ClassImp(fitFparent)
 ...
 fitFparent::fitFparent(const char *name, const char *title,
                        RooAbsReal& _x,
                        RooAbsCategory& _y,
                        RooAbsReal& _neueff,
                        RooAbsReal& _p0,
 ...
 fitFparent::fitFparent(const fitFparent& other, const char* name) :
 ...
 Double_t fitFparent::evaluate() const
 {
     Double_t par0[19];
     par0[0]=p0;
     par0[1]=p1;
 ...
 //! Global function
 Double_t fitFparent::fcn_gen(Double_t t, Double_t *par) const{
     Int_t npaths;
 ...
 Double_t fitFparent::fcn_gen_w1neutron(Double_t t, Double_t *par) const{
     Int_t npaths;
     Int_t ndecay[kmaxpaths];
     Int_t decaymap[kmaxpaths][kmaxndecay];
     Int_t nneu[kmaxpaths][kmaxndecay];
 ...
 Double_t fitFparent::fcn_gen_w2neutron(Double_t t, Double_t *par) const{
     Int_t npaths;
     Int_t ndecay[kmaxpaths];
     Int_t decaymap[kmaxpaths][kmaxndecay];
     Int_t nneu[kmaxpaths][kmaxndecay];
 ...
 Double_t fitFparent::corefcn(Int_t ndecay,Int_t* decaymap,Int_t* nneu, Double_t* b1n,Double_t* b2n,Double_t* lamda,Double_t N0,Double_t t) const{
     Double_t fcnret=0;
