...
double fdecay1n=fparentdecay*(randcoinf1n+ne0*p1n0*(1-randcoinf1n-randcoinfgt0n)+2*(ne0*(1-ne0))*p2n0*(1-randcoinf1n-randcoinfgt0n)-ne0*ne0*p2n0*randcoinf1n);
...
double fdecay2n=fparentdecay*(ne0*ne0*p2n0*(1-randcoinf2n-randcoinfgt0n)+randcoinf2n+ne0*p1n0*(randcoinf1n*(1-randcoinfgt0n)-randcoinf2n)+2*(ne0*(1-ne0))*p2n0*(randcoinf1n*(1-randcoinfgt0n)-randcoinf2n));
