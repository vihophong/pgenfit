...
double f10=l8*py1*(1-p1n0-p2n0)*l0*py4*(1-p1n1-p2n1)*l1*py8*p1n4*l4*(e0/((l1-l0)*(l4-l0)*(l8-l0)*1)+e1/((l0-l1)*(l4-l1)*(l8-l1)*1)+e4/((l0-l4)*(l1-l4)*(l8-l4)*1)+e8/((l0-l8)*(l1-l8)*(l4-l8)*1)+0)*N0;
...
double f16=l9*py1*(1-p1n0-p2n0)*l0*py6*p2n1*l1*py9*(1-p1n6-p2n6)*l6*(e0/((l1-l0)*(l6-l0)*(l9-l0)*1)+e1/((l0-l1)*(l6-l1)*(l9-l1)*1)+e6/((l0-l6)*(l1-l6)*(l9-l6)*1)+e9/((l0-l9)*(l1-l9)*(l6-l9)*1)+0)*N0;
...
double f20=l10*py1*(1-p1n0-p2n0)*l0*py4*(1-p1n1-p2n1)*l1*py8*p1n4*l4*py10*(1-p1n8-p2n8)*l8*(e0/((l1-l0)*(l4-l0)*(l8-l0)*(l10-l0)*1)+e1/((l0-l1)*(l4-l1)*(l8-l1)*(l10-l1)*1)+e4/((l0-l4)*(l1-l4)*(l8-l4)*(l10-l4)*1)+e8/((l0-l8)*(l1-l8)*(l4-l8)*(l10-l8)*1)+e10/((l0-l10)*(l1-l10)*(l4-l10)*(l8-l10)*1)+0)*N0;
double f21=l10*py1*(1-p1n0-p2n0)*l0*py5*p1n1*l1*py8*(1-p1n5-p2n5)*l5*py10*(1-p1n8-p2n8)*l8*(e0/((l1-l0)*(l5-l0)*(l8-l0)*(l10-l0)*1)+e1/((l0-l1)*(l5-l1)*(l8-l1)*(l10-l1)*1)+e5/((l0-l5)*(l1-l5)*(l8-l5)*(l10-l5)*1)+e8/((l0-l8)*(l1-l8)*(l5-l8)*(l10-l8)*1)+e10/((l0-l10)*(l1-l10)*(l5-l10)*(l8-l10)*1)+0)*N0;
double f22=l10*py2*p1n0*l0*py5*(1-p1n2-p2n2)*l2*py8*(1-p1n5-p2n5)*l5*py10*(1-p1n8-p2n8)*l8*(e0/((l2-l0)*(l5-l0)*(l8-l0)*(l10-l0)*1)+e2/((l0-l2)*(l5-l2)*(l8-l2)*(l10-l2)*1)+e5/((l0-l5)*(l2-l5)*(l8-l5)*(l10-l5)*1)+e8/((l0-l8)*(l2-l8)*(l5-l8)*(l10-l8)*1)+e10/((l0-l10)*(l2-l10)*(l5-l10)*(l8-l10)*1)+0)*N0;
fdecay+=f0+f1+f2+f3+f4+f5+f6+f7+f8+f9+f10+f11+f12+f16+f17+f18+f20+f21+f22+0;

double randcoinf2n=*p[58];
double randcoinfgt0n=*p[57];
double randcoinf1n=*p[56];
double fdecay1n=fparentdecay*(be*randcoinf1n+b1ne*ne0*p1n0*(1-randcoinf1n-randcoinfgt0n)+b2ne*2*(ne0*n1n2ne*(1-ne0*n1n2ne))*p2n0*(1-randcoinf1n-randcoinfgt0n)-b2ne*ne0*n1n2ne*ne0*n1n2ne*p2n0*randcoinf1n);
...
fdecay1n+=f10*(randcoinf1n+ne8*p1n8*(1-randcoinf1n-randcoinfgt0n)+2*(ne8*(1-ne8))*p2n8*(1-randcoinf1n-randcoinfgt0n)-ne8*ne8*p2n8*randcoinf1n);
...
fdecay1n+=f22*(randcoinf1n+ne10*p1n10*(1-randcoinf1n-randcoinfgt0n)+2*(ne10*(1-ne10))*p2n10*(1-randcoinf1n-randcoinfgt0n)-ne10*ne10*p2n10*randcoinf1n);
double fdecay2n=fparentdecay*(b2ne*ne0*n1n2ne*ne0*n1n2ne*p2n0*(1-randcoinf2n-randcoinfgt0n)+randcoinf2n*be+b1ne*ne0*p1n0*(randcoinf1n*(1-randcoinfgt0n)-randcoinf2n)+b2ne*2*(ne0*n1n2ne*(1-ne0*n1n2ne))*p2n0*(randcoinf1n*(1-randcoinfgt0n)-randcoinf2n));
...
fdecay2n+=f10*(ne8*ne8*p2n8*(1-randcoinf2n-randcoinfgt0n)+randcoinf2n+ne8*p1n8*(randcoinf1n*(1-randcoinfgt0n)-randcoinf2n)+2*(ne8*(1-ne8))*p2n8*(randcoinf1n*(1-randcoinfgt0n)-randcoinf2n));
...
fdecay2n+=f22*(ne10*ne10*p2n10*(1-randcoinf2n-randcoinfgt0n)+randcoinf2n+ne10*p1n10*(randcoinf1n*(1-randcoinfgt0n)-randcoinf2n)+2*(ne10*(1-ne10))*p2n10*(randcoinf1n*(1-randcoinfgt0n)-randcoinf2n));
