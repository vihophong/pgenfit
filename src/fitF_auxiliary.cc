...
double f34=l13*py1*(1-p1n0-p2n0)*l0*py4*(1-p1n1-p2n1)*l1*py7*(1-p1n4-p2n4)*l4*py10*(1-p1n7-p2n7)*l7*py13*(1-p1n10-p2n10)*l10*(e0/((l1-l0)*(l4-l0)*(l7-l0)*(l10-l0)*(l13-l0)*1)+e1/((l0-l1)*(l4-l1)*(l7-l1)*(l10-l1)*(l13-l1)*1)+e4/((l0-l4)*(l1-l4)*(l7-l4)*(l10-l4)*(l13-l4)*1)+e7/((l0-l7)*(l1-l7)*(l4-l7)*(l10-l7)*(l13-l7)*1)+e10/((l0-l10)*(l1-l10)*(l4-l10)*(l7-l10)*(l13-l10)*1)+e13/((l0-l13)*(l1-l13)*(l4-l13)*(l7-l13)*(l10-l13)*1)+0)*N0;
fdecay+=f0+f1+f2+f3+f4+f5+f8+f9+f11+f12+f18+f19+f22+f23+f33+f34+0;
