...
#ifndef FITFDAUGHTERS
#define FITFDAUGHTERS
...
class fitFdaughters : public RooAbsPdf {
public:
  fitFdaughters() {} ;
  fitFdaughters(const char *name, const char *title,
              RooAbsReal& _x,
              RooAbsCategory& _y,
              RooAbsReal& _neueff,
              RooAbsReal& _p0,
              ...
              RooAbsReal& _p20,
              RooAbsReal& _p21);
  fitFdaughters(const fitFdaughters& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new fitFdaughters(*this,newname); }
  inline virtual ~fitFdaughters() { }
...
private:
  ...
  ClassDef(fitFdaughters,1) // Your description goes here...
};
